            ...
            <div class="p-8 profile-body">
                ...
                <div class="flex border-b border-gray-200 mb-8">
                    ...
                    <button onclick="switchTab('security')" id="security-tab" 
                            class="tab-btn flex items-center px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 focus:outline-none">
                ...
                <div id="security-content" class="hidden">
                    <form action="{{ route('admin.profil.ganti-password') }}" method="POST" class="space-y-6" data-spa-ignore onsubmit="return confirmPasswordChange(event)">
                        @csrf
...
function hapusFoto() {
    showConfirmDialog(
        ...
        function() {
            ...
            form.method = 'POST';
            form.action = '{{ route("admin.profil.hapus-foto") }}';
