...
html[data-theme="dark"] #formPengaturan > .rounded-2xl {
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit" id="btnSimpan" form="formPengaturan"
                            class="px-5 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center gap-2 hidden"
                ...
                <div class="px-6 py-4" style="background: linear-gradient(135deg, #3b82f6, #6366f1);">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-blue-200 text-xs">Logo dan favicon website perpustakaan</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-3">
                                <i class="fas fa-image text-blue-500 mr-1.5"></i>Logo Website
                            </label>
                            <div class="flex flex-col items-center gap-4">
                                <div class="relative group">
                                    <div id="logoPreviewContainer"
                                        ...
                                        @if($pengaturan->logo)
                                            ...
                                            <div id="logoPlaceholder" class="hidden flex-col items-center gap-2 text-blue-300">
                                        ...
                                        @else
                                            ...
                                            <div id="logoPlaceholder" class="flex flex-col items-center gap-2 text-blue-300">
                                                <i class="fas fa-image text-3xl"></i>
                                ...
                                <button type="button" onclick="document.getElementById('logo').click()"
                                        class="upload-btn px-4 py-2 rounded-xl text-sm font-medium text-blue-600 transition-all duration-200 hover:scale-105"
                                        style="background: rgba(59,130,246,0.08); border: 1px solid rgba(59,130,246,0.15);" disabled>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-3">
                                <i class="fas fa-star text-blue-500 mr-1.5"></i>Favicon
                            </label>
                            <div class="flex flex-col items-center gap-4">
                                <div class="relative group">
                                    <div id="faviconPreviewContainer"
                                        ...
                                        @if($pengaturan->favicon)
                                            ...
                                            <div id="faviconPlaceholder" class="hidden flex-col items-center gap-2 text-blue-300">
                                                <i class="fas fa-star text-3xl"></i>
                                                <span class="text-xs">Tidak ditemukan</span>
                                            </div>
                                        @else
                                            <img id="faviconPreview" src="" alt="Favicon" class="w-20 h-20 object-contain hidden">
                                            <div id="faviconPlaceholder" class="flex flex-col items-center gap-2 text-blue-300">
                                                <i class="fas fa-star text-3xl"></i>
                ...
                <div class="p-6 border-b border-gray-100 space-y-5">
                    <div>
                        ...
                        <input type="text" name="nama_website" id="nama_website" value="{{ $pengaturan->nama_website }}"
                               class="w-full px-4 py-3 rounded-xl text-sm transition-all duration-200 focus:ring-2 focus:ring-blue-400 focus:outline-none"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_website" id="deskripsi_website" rows="4"
                                  class="w-full px-4 py-3 rounded-xl text-sm transition-all duration-200 focus:ring-2 focus:ring-blue-400 focus:outline-none resize-none"
                                  style="background: rgba(59,130,246,0.03); border: 1px solid rgba(59,130,246,0.12);"
                ...
                <div class="px-6 py-4" style="background: linear-gradient(135deg, #3b82f6, #6366f1);">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-blue-200 text-xs">Data dan kontak sekolah</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <label for="alamat_sekolah" class="block text-sm font-semibold text-gray-700 mb-1.5">
                            <i class="fas fa-map-marker-alt text-blue-500 mr-1.5"></i>Alamat Sekolah
                        </label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="telepon_sekolah" class="block text-sm font-semibold text-gray-700 mb-1.5">
                                <i class="fas fa-phone text-blue-500 mr-1.5"></i>Telepon
                            </label>
                    ...
                    <div>
                        <label for="nama_kepala_sekolah" class="block text-sm font-semibold text-gray-700 mb-1.5">
                            <i class="fas fa-user-tie text-blue-500 mr-1.5"></i>Kepala Sekolah
                        </label>
                    ...
                    <div>
                        <label for="jam_operasional" class="block text-sm font-semibold text-gray-700 mb-1.5">
                            <i class="fas fa-clock text-blue-500 mr-1.5"></i>Jam Operasional
                        </label>
